...
namespace CoinEx.Net.Interfaces.Clients.FuturesApi
{
    ...
    public interface ICoinExClientFuturesApiTrading
    {
        ...
        Task<WebCallResult<CoinExNewPosition>> PlaceOrderAsync(
            string symbol,
        ...
        Task<WebCallResult<CoinExMarketCloseAll>> MarketCloseAllAsync(string symbol, long positionID, CancellationToken ct = default);
    }
}
