...
namespace CoinEx.Net.Clients.FuturesApi
{
    ...
    public class CoinExClientFuturesApi : RestApiClient, ICoinExClientFuturesApi, IFuturesClient
    {
        ...
        async Task<WebCallResult<IEnumerable<Order>>> IBaseRestClient.GetOpenOrdersAsync(string? symbol, CancellationToken ct)
        {
            ...
            //var openOrders = await Trading.GetOpenPositionsAsync(symbol!, ct: ct).ConfigureAwait(false);
            //if (!openOrders)
            ...
            //{
            //    SourceObject = o,
            //    Id = o.PositionId.ToString(CultureInfo.InvariantCulture),
            //    Price = o.Price,
            //    Quantity = o.Quantity,
        ...
        public override TimeSyncInfo GetTimeSyncInfo()
            => new TimeSyncInfo(_log, _options.SpotApiOptions.AutoTimestamp, _options.FuturesApiOptions.TimestampRecalculationInterval, TimeSyncState);

        /// <inheritdoc />
        public override TimeSpan GetTimeOffset()
            => TimeSyncState.TimeOffset;

        Task<WebCallResult<IEnumerable<Position>>> IFuturesClient.GetPositionsAsync(CancellationToken ct)
        {
            throw new NotImplementedException();
        }
