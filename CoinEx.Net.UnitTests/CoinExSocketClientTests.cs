...
namespace CoinEx.Net.UnitTests
{
    ...
    public class CoinExSocketClientTests
    {
        ...
        {
            // Arrange
            var options = new CoinExSocketClientOptions()
            {
                LogLevel = LogLevel.Debug,
            };
            var client = new CoinExSocketClient(options);
            ...
            var subTask = client.FuturesStreams.SubscribeToKlineUpdatesAsync("ETHUSDT", KlineInterval.FiveMinutes, (data) =>
            {
                actual = data.Data.ToArray();
            });
            subTask.Wait();
